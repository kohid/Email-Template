        ...
        <head>
            ...
            <style>
                ...
                .email-container {
                    ...
                    <?php if (isset($settings['canvas_box_shadow'])): ?>box-shadow: <?php echo esc_attr($settings['canvas_box_shadow']); ?> !important;
                    <?php endif; ?>
                }

                <?php if (isset($settings['global_typography'])): ?><?php if (isset($settings['global_typography']['headings'])): ?>h1,
                h2,
                h3,
                h4,
                h5,
                ...
                <?php endif; ?><?php if (isset($settings['global_typography']['paragraph'])): ?>p {
                    ...
                    <?php if (isset($settings['global_typography']['paragraph']['line_height'])): ?>line-height: <?php echo esc_attr($settings['global_typography']['paragraph']['line_height']); ?> !important;
                    <?php endif; ?>
                }

                <?php endif; ?><?php if (isset($settings['global_typography']['link'])): ?>a {
                ...
                <?php endif; ?><?php if (isset($settings['global_typography']['button'])): ?>.tdt-button {
